...
plt.tight_layout()
plt.savefig("../images/top10state.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("../images/top10city.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("../images/remoteindustries.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("../images/top15techhubs.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("../images/urbanai.png", dpi=300)
plt.show()
